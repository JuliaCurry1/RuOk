...
#CPK: no need to set wd if data are in project dir
library(tidyverse)
library(features)
library(ggplot2)
...
#CPK: There's no calculation of the max amp.sum per fin beat [-3]
...
#CPK: Nice work. Just be sure to address all the prompts precisely.
#CPK: Total points: 17
